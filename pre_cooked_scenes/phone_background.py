...
back_wall_3 = SmoothPlane(CoordinateSystem(origin=Vector(-9, 0, -6), orientation=Vector(1, 0, 0), angle=0.5),
                          ...
                          length=5)
back_wall_4 = SmoothPlane(CoordinateSystem(origin=Vector(-9.15+3, 0-1, 5+1+2), orientation=Vector(1, 1, -1), angle=0.8),
                          Material(diffuse_light_reflectivity=WHITE * 0.6), width=30,
                          length=5)
background = [back_wall_1, back_wall_2, back_wall_3, back_wall_4]
...
objects = background + [e1, s1, s2, lens2]
